package com.example.administrator.jingdong.httputils.Fl_http;
...
public class Fl_HttpUtils {
    private static final String TAG = "HttpUtils-----";
    private static HttpUtils fl_httpUtils;
    private final int SUCCESS = 0;
    private final int ERROR = 1;
    private MyHandler myHandler = new MyHandler();
    private Fl_OkLoadListener okLoadListener;

    public static Fl_HttpUtils getHttpUtils() {
        if (fl_httpUtils == null) {
            fl_httpUtils = new HttpUtils();
        }
        return fl_httpUtils;
    }
    ...
    public void setOkLoadListener(Fl_OkLoadListener okLoadListener) {
